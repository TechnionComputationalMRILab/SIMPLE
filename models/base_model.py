...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        self.save_dir = os.path.join(opt.save_dir, opt.checkpoints_dir)
    ...
    def save_specific_networks(self, networks_names, epoch):
        """Save all the networks to the disk.
    ...
    def load_networks(self, epoch, pre_train_G_path='', pre_train_W_path=''):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                if name == 'G' and pre_train_G_path != '':
                    load_path = pre_train_G_path
                elif name == 'W' and pre_train_W_path != '':
                    load_path = pre_train_W_path
                else:
    ...
    def load_specific_networks(self, networks_names, load_paths):
        """Load all the networks from the disk.
