...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--atme_cor_root', type=str, default='atme_coronal_output', help='path to atme coronal images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--atme_ax_root', type=str, default='atme_axial_output', help='path to atme axial images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--plane', type=str, default='coronal', help='define the plane the atme is trained on')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='atme', help='chooses which model to use. [atme]')
