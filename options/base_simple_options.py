...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/tcmldrive/databases/Private/RambamMRE082022Sorter/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--main_root', default='outputs', help='path to save script outputs (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--calculate_dataset', type=bool, default=False, help='if specified, calculate and pre-preprocess dataset')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='simple', help='chooses which model to use. [simple]')
        parser.add_argument('--direction', type=str, default='AtoB', help='AtoB or BtoA')
        parser.add_argument('--input_nc', type=int, default=1, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--output_nc', type=int, default=1, help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf_cor', type=int, default=16, help='# of discrim filters in the first conv layer')
        parser.add_argument('--ndf_ax', type=int, default=64, help='# of discrim filters in the first conv layer')
        parser.add_argument('--netD_cor', type=str, default='n_layers', help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netD_ax', type=str, default='n_layers', help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
    ...
    def print_options(self, opt):
        ...
        # save to the disk
        expr_dir = os.path.join(opt.main_root, opt.simple_root, opt.exp_name, opt.checkpoints_dir)
